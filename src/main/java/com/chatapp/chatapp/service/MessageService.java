...
public class MessageService {
    ...
    public void postMessageToChatView(String text, String chatViewId, ZonedDateTime createdAt, Principal principal) {
        ...
        // Deliver message to all users (online via WebSocket, offline via RabbitMQ queue)
     ...
     * Online users receive via WebSocket immediately.
        ...
        for (String userUid : userUids) {
            try {
                ...
                if (isOnline) {
                    ...
                    String destination = "/topic/chatview." + chatViewId + ".user." + userUid;
